...
class TestWorkerAnalyzeFileHappyPath:
    async def test_analyze_file_success(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe, mock_with_retry, mock_log_tool_call):
        mock_read_file_safe.return_value = ("file content", 100)
        mock_with_retry.return_value = MagicMock(content="analysis result", model="mock_model", tokens_input=10, tokens_output=20, latency_ms=100)
...
class TestWorkerAnalyzeFileEdgeCases:
    async def test_analyze_file_empty_content(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe, mock_with_retry, mock_log_tool_call):
        mock_read_file_safe.return_value = ("", 0)
        mock_with_retry.return_value = MagicMock(content="empty analysis", model="mock_model", tokens_input=5, tokens_output=5, latency_ms=50)
    ...
    async def test_analyze_file_large_content(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe, mock_with_retry, mock_log_tool_call):
        large_content = "line\n" * 10000
        mock_read_file_safe.return_value = (large_content, 10000)
        mock_with_retry.return_value = MagicMock(content="large analysis", model="mock_model", tokens_input=1000, tokens_output=1000, latency_ms=500)
...
class TestWorkerAnalyzeFileErrorHandling:
    async def test_analyze_file_not_found(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe):
    ...
    async def test_analyze_file_permission_error(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe):
    ...
    async def test_analyze_file_worker_error(self, mock_provider, mock_prompt_engine, mock_metrics, mock_call_tracker, mock_read_file_safe, mock_with_retry):
        mock_read_file_safe.return_value = ("file content", 100)
